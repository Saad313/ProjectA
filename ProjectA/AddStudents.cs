...
namespace ProjectA
{
    public partial class AddStudents : Form
    {
        ...
        {
            if (!string.IsNullOrEmpty(txtfname.Text) && !string.IsNullOrEmpty(txtLname.Text) && !string.IsNullOrEmpty(txtEmail.Text) && !string.IsNullOrEmpty(txtcontactNo.Text) && !string.IsNullOrEmpty(txtRegNo.Text))
            {
